...
export default function ProfilePreview() {
  ...
  return (
    <main className="min-h-screen bg-gray-50 relative pt-20 px-4 md:px-6 lg:px-8">
      {" "}
      {/* Hamburger Menu */}{" "}
      <div className="fixed top-4 left-4 z-50">
        ...
        {menuOpen && (
          <ul className="absolute left-0 mt-12 w-40 bg-white border rounded shadow-md">
            {" "}
            <li>
              {" "}
              <Link
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        {" "}
        {/* Profile Card */}{" "}
        <div className="lg:col-span-4 bg-white rounded-2xl shadow p-5 md:p-6">
          {" "}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 mt-6">
        {" "}
        {/* Activity */}{" "}
        <div className="lg:col-span-8 bg-white rounded-2xl shadow p-5 md:p-6">
          {" "}
        ...
        <div className="lg:col-span-4 bg-white rounded-2xl shadow p-5 md:p-6">
          ...
          <div className="space-y-3">
            ...
            <button
              className="w-full py-2 rounded-lg text-sm bg-red-50 text-red-600 hover:bg-red-100"
